...
**release-notes-bot — perpetual single-purchase license**
...
You bought it once. You own your copy forever. Run it against as many of **your own** repositories and releases as you
like. Do not resell it as a product of its own.

## What you may do

- Use the software for any purpose, commercial or personal, forever.
- Run it on unlimited repositories that you own or operate.
- Use it in client work, and use the release notes and changelogs it
  produces however you like — including publishing them to customers.
...
Selling the *output* — release notes, changelog-writing services — is
explicitly allowed. Selling *the tool* is not.
...
In particular: this tool drafts release notes from your repository's own
merged pull requests via GitHub's API, and commits the result to
CHANGELOG.md on your behalf. You are responsible for reviewing what it
commits and publishes before treating it as final, and for your own API
keys, tokens, and their associated costs and access scopes.
