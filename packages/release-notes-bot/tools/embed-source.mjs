// Regenerates netlify/lib/release-notes-bot-source.mts from the real package source.
//
// Run this after changing anything in the package:
//
//   node packages/release-notes-bot/tools/embed-source.mjs
//
...
const OUTPUT = join(REPO_ROOT, 'netlify', 'lib', 'release-notes-bot-source.mts')
...
export function renderModule(files) {
  const lines = [
    ...
    '//',
    '// Produced by packages/release-notes-bot/tools/embed-source.mjs from the real',
    '// package source. Regenerate after changing the package:',
    '//',
    '//   node packages/release-notes-bot/tools/embed-source.mjs',
    '//',
    '// This is the payload for the Release Notes Bot product (SKU AI-AB-028): the',
    ...
    '}',
    '',
    'export const RELEASE_NOTES_BOT_SOURCE: SourceFile[] = [',
  ]
