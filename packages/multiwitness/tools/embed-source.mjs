// Regenerates netlify/lib/multiwitness-source.mts from the real package
// source. Same pattern as the MultiConnect embed scripts.
//
...
const OUTPUT = join(REPO_ROOT, 'netlify', 'lib', 'multiwitness-source.mts')
