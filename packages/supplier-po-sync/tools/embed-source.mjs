// Regenerates netlify/lib/supplier-po-sync-source.mts from the real package source.
//
// Run this after changing anything in the package:
//
//   node packages/supplier-po-sync/tools/embed-source.mjs
//
// Same rationale as every other source-code product in this repo (see
// packages/code-review-digest/tools/embed-source.mjs): delivery has to be
...
const OUTPUT = join(REPO_ROOT, 'netlify', 'lib', 'supplier-po-sync-source.mts')
...
export function renderModule(files) {
  const lines = [
    ...
    '//',
    '// Produced by packages/supplier-po-sync/tools/embed-source.mjs from the real',
    '// package source. Regenerate after changing the package:',
    '//',
    '//   node packages/supplier-po-sync/tools/embed-source.mjs',
    '//',
    '// This is the payload for the Supplier PO & Inventory Sync product: the',
    ...
    '}',
    '',
    'export const SUPPLIER_PO_SYNC_SOURCE: SourceFile[] = [',
  ]
