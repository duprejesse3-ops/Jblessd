// Regenerates netlify/lib/multivault-source.mts from the real package
// source. Same pattern as the MultiWitness/MultiGuard embed scripts.
//
...
const OUTPUT = join(REPO_ROOT, 'netlify', 'lib', 'multivault-source.mts')

const INCLUDE_DIRS = ['lib', 'bin', 'adapters', 'test', 'scripts']
