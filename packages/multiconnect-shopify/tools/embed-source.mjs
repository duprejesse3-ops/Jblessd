// Regenerates netlify/lib/multiconnect-shopify-source.mts from the real
// package source. Same pattern as the webhook bridge's embed-source.mjs.
//
...
const OUTPUT = join(REPO_ROOT, 'netlify', 'lib', 'multiconnect-shopify-source.mts')
