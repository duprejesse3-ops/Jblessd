// Regenerates netlify/lib/multiconnect-google-docs-source.mts from the real
// package source. Same pattern as the other MultiConnect embed scripts.
//
...
const OUTPUT = join(REPO_ROOT, 'netlify', 'lib', 'multiconnect-google-docs-source.mts')
