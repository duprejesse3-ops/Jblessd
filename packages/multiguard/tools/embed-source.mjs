// Regenerates netlify/lib/multiguard-source.mts from the real package
// source. Same pattern as the other MultiConnect embed scripts.
//
...
const OUTPUT = join(REPO_ROOT, 'netlify', 'lib', 'multiguard-source.mts')
