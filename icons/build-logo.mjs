// Generates the MULTI-VICE AI matrix logo as SVG (standard + maskable variants).
...
function svg({ maskable }) {
  ...
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${S} ${S}" width="${S}" height="${S}" role="img" aria-label="MULTI-VICE AI">
  <title>MULTI-VICE AI</title>
${defs()}
