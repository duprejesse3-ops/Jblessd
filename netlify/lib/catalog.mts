...
export const FALLBACK_CATALOG: Product[] = [
  ...
  { sku: 'AI-CN-008', name: 'MultiVault', category: 'connectors', niche: 'founders', format: '.zip download · zero dependencies · perpetual license · optional standalone binary', price: 69, blurb: 'A local, encrypted context snapshot of one folder and one calendar file — turned into a pasteable brief for any AI chat, or piped into your own scripts. No account, no OAuth, no cloud storage: the vault lives on your machine and only your passphrase opens it.', spec: 'AES-256-GCM · scrypt-derived key · cron/launchd/Task Scheduler adapters included' },
]
